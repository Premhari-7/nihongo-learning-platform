...
- **Current Production Backend URL**: `https://nihongo-backend-production-83ec.up.railway.app`
...
- **Rate Limiting**: Operational. The `express-rate-limit` proxy issues behind Railway's load balancers have been resolved by implementing `app.set('trust proxy', 1)`.
